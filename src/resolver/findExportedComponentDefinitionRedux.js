...
import isReduxConnectCall from '../utils/isReduxConnectCall';
...
function resolveDefinition(definition, types) {
  if (isReactCreateClassCall(definition)) {
    ...
    return definition;
  } else if (isReduxConnectCall(definition)) {
		const resolvedPath = resolveToValue(definition.get('arguments', 0));
 ...
 */
export default function findExportedComponentDefinitionRedux(
  ast: ASTNode,
  recast: Object,
): ?NodePath {
